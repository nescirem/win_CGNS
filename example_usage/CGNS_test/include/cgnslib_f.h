...
!* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
        ...
        integer PointList, PointListDonor
        integer PointRange, PointRangeDonor
...
!**                             Chemistry_LinRessler
        ...
        integer EddyViscosity, ReynoldsStress
        integer ReynoldsStressAlgebraic
        integer Algebraic_BaldwinLomax, Algebraic_CebeciSmith
        integer HalfEquation_JohnsonKing, OneEquation_BaldwinBarth
        integer OneEquation_SpalartAllmaras
        integer TwoEquation_JonesLaunder
        ...
        integer ChemicalEquilibCurveFit
        integer ChemicalEquilibMinimization
        integer ChemicalNonequilib
        integer EMElectricField, EMMagneticField, Voltage
        integer Interpolated
...
!* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
        ...
        integer BCAxisymmetricWedge, BCDegenerateLine
        integer BCDegeneratePoint
...
!* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
        ...
        integer NODE, BAR_2, BAR_3, TRI_3, TRI_6
        integer QUAD_4, QUAD_8, QUAD_9
        integer TETRA_4, TETRA_10, PYRA_5, PYRA_14
        integer PENTA_6, PENTA_15, PENTA_18
        integer HEXA_8, HEXA_20, HEXA_27
        integer MIXED, PYRA_13, NGON_n, NFACE_n
        integer BAR_4, TRI_9, TRI_10
        integer QUAD_12, QUAD_16
        integer TETRA_16, TETRA_20
        integer PYRA_21, PYRA_29, PYRA_30
        integer PENTA_24, PENTA_38, PENTA_40
        integer HEXA_32, HEXA_56, HEXA_64
